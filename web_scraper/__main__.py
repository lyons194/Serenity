...
def set_page():
    try:
        ...
        """
        with closing(get(sp_a, stream=True)) as resp:
            print(resp.content)
        """
...
b2 = Button(root, text="Scrape web page", width=15,command=set_page,activebackground="pink", activeforeground="blue")
b2.place(x=20,y=80)


notice1 = Label(root, text="Wishing Well Computing")
notice1.place(x=10,y=140)
